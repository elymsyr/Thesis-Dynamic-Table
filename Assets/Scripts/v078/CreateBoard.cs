...
public class CreateBoard078 : MonoBehaviour
{
    ...
    public float ObjectPos(float diff){
        ...
        productCollision078 productClass = product.GetComponent<productCollision078>();
    ...
    private Vector3 randomPos(){
        return new Vector3(Random.Range(wallBorders[0]-(scale/2)-2.1f, wallBorders[1]+(scale/2)+2.1f), Random.Range(6f,7f), Random.Range(wallBorders[2]-(scale/2)-2.1f, wallBorders[3]+(scale/2)+2.1f));
    }    
