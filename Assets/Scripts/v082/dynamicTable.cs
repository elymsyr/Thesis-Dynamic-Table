...
public class dynamicTable082 : Agent
{
    [Header("UI")]
    ...
    private productCollision082 productClass;
    private StatsRecorder recorder;
    private int lastStep = 0;
    private float heighpoint;
    private CreateBoard082 Labyrynt;
    ...
    void Awake()
    {
        if (pathfinder != null){AStar = pathfinder.GetComponent<AStar082>();}
        Labyrynt = transform.GetComponent<CreateBoard082>();
        ...
        productClass = product.GetComponent<productCollision082>();
    ...
    public override void OnEpisodeBegin()
    {
        ...
        MaxStep = (int)(400);
        // if(CompletedEpisodes%5 == 0 && maze){ // maze && (int)(MazeDifficulty*10+1)%(CompletedEpisodes+1) < 3
